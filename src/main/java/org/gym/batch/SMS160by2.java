...
public class SMS160by2 implements SMS{
    ...
    public boolean login(String userName, String password) {
        ...
        HttpPost post = new HttpPost("http://www.160by2.com/Login");
    ...
    public void send(String mobileNo, String msg) throws NotAuthenticatedException {
        ...
        HttpPost post = new HttpPost("http://www.160by2.com/SendSMSDec19");
        List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
        nameValuePairs.add(new BasicNameValuePair("hid_exists", "no"));
        nameValuePairs.add(new BasicNameValuePair("feb2by2action", "65dfvvg4gfg2"));
        nameValuePairs.add(new BasicNameValuePair("WBIHXQ", mobileNo));
        nameValuePairs.add(new BasicNameValuePair("sendSMSMsg", msg));
        nameValuePairs.add(new BasicNameValuePair("hidSessionId", "BD879096116BE9B69E5E670C3B931480.8511"));
        nameValuePairs.add(new BasicNameValuePair("maxwellapps", ""));
