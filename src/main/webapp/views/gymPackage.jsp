...
<style>
#ajaxSearch .autocomplete-suggestions { border: 1px solid #999; background: #FFF; overflow: auto; }
#ajaxSearch .autocomplete-suggestion { padding: 5px 5px; white-space: nowrap; overflow: hidden; font-size:22px}
#ajaxSearch .autocomplete-selected { background: #F0F0F0; }
#ajaxSearch .autocomplete-suggestions strong { font-weight: bold; color: #3399FF; }
</style>
...
<section class="content">
	...
	<div class="form-box" id="login-box"
		style="margin: 15px 45px 45px 45px;">
		<div class="header">Add/Edit Package</div>
