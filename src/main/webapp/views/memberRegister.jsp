...
<span><c:if test="${not empty message}">
		<div class="form-group has-success">
			<label class="control-label" for="inputSuccess"><i
				class="fa fa-check"></i> User registered succesfully with member Id
				: <c:out value="${memberId}" /> </label>
		</div>
	</c:if></span>
<!-- Main content -->
<section class="content">
	<div class="form-box" id="login-box" style="margin:15px 45px 45px 45px;">
		<div class="header">Register New Membership</div>
		<f:form action="memberRegisterSubmit" method="post"
			modelAttribute="memberRegister" id="memberRegisterSubmit">
